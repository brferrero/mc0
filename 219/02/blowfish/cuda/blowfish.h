...
__global__ void blowfish_encrypt(const BYTE in[], BYTE out[], const BLOWFISH_KEY *keystruct, size_t size);
__global__ void blowfish_decrypt(const BYTE in[], BYTE out[], const BLOWFISH_KEY *keystruct, size_t size);
